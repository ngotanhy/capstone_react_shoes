                    ...
                    <div className="flex">
                        <div className="basis-1/2 register-left ">
                            <div className="w-full">
                                ...
                                <input type="text" className='bg-slate-200 outline-none p-2 font-normal text-base w-full' id="email" placeholder=" " name="clearCache" autoComplete="off" />
                            </div>
                            <div className="w-full">
                                <label htmlFor="password" className='block'>Password</label>
                                <input type="password" className='bg-slate-200 outline-none p-2 font-normal text-base w-full' id="password" placeholder=" " name="clearCache" autoComplete="off" />
                            </div>
                        </div>
                        ...
                        <div className="basis-1/2 register-right">
                            <div className="w-full">
                                ...
                                <input type="text" className='bg-slate-200 outline-none p-2 font-normal text-base w-full' id="name" placeholder=" " name="clearCache" autoComplete="off" />
                            </div>
                            <div className="w-full">
                                <label htmlFor="phone" className='block'>Phone</label>
                                <input type="text" className='bg-slate-200 outline-none p-2 font-normal text-base w-full' id="phone" placeholder=" " name="clearCache" autoComplete="off" />
                            </div>
